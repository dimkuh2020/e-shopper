...
//use app\assets\ltAppAsset;  // для IE8 и ниже. Нужно создать класс ItAppAsset.php в папке assets и только подключить 2 скрипта + $jsOptions = [position + condition]
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <!--переход на главную страницу логотипом-->
